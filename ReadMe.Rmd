...
#### Source
The raw data was collected from the accelerometers from the Samsung Galaxy S smartphone. More information about can be found at: 
...
Note: The script will install and load the required package if necessary.


#### Acknowledgements

I would like to thank the many students and CTAs on the Coursera class forums for Getting & Cleaning Data whose questions and answers provided an invaluable resource in the completion of this project.
